# Java 1 - 10. cvičení v2 - test

## Projekt
Zadání je v projektu <https://gitlab.vsb.cz/jez04-vyuka/java1/labs/lab10v2.git>

## Zadání
Zadání je ve třídách:

- `lab.calc.AppCalc`
- `lab.docs.AppDoc`
- `lab.socnet.AppSocialNetwork`

Vše můžete pouštět pomocí metody main v `lab.App`.
Nebo lze pouštět dílčí částí ve třídách:

- `lab.calc.AppCalc`
- `lab.docs.AppDoc`
- `lab.socnet.AppSocialNetwork`

Dostupné jsou také unit testy stejné jako v Kelvinu.
